...
export default {
  ...
  loadingArena: 'Loading Smash or Pass arena...',
  loadingRankings: 'Loading Hall of Fame rankings...',
  stats: 'Info',
  reset: 'Reset',
  rosters: {
    canon: {
  ...
  personaArchetypes: {
    untappedSoul: {
      ...
      subtitle: 'Your trial desires remain veiled in the Fog.',
      desc: 'Evaluate candidates to unlock your psychological profile, dating analysis, and affinity balance.',
    },
    fogRomantic: {
  ...
  tooltips: {
    ...
    leaderboardDesc: 'Global community smash rankings and tier lists.',
    shuffle: 'Shuffle Remaining',
    shuffleDesc: 'Randomize the remaining candidates in your deck.',
    resetAllVotes: 'Reset Voting Data',
    resetDesc: 'Clear your votes and restore all candidate cards.',
    howToPlay: 'How to Play & Keybindings',
    howToPlayDesc: 'View controls, keycaps, and trial dating rules.',
