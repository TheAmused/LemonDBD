  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-3 bg-slate-50/80 dark:bg-slate-950/50 border-b border-slate-200/80 dark:border-slate-800/80 grid grid-cols-3 gap-2">
          ...
          <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
            ...
            <span className="block text-xs font-black text-rose-500 dark:text-rose-400 truncate">{killerTerrorRadius}</span>
          </div>
          <div className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center">
