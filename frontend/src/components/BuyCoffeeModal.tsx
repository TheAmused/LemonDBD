// frontend/src/components/BuyCoffeeModal.tsx
'use client';
...
export const BuyCoffeeModal: React.FC<BuyCoffeeModalProps> = ({ isOpen, onClose }) => {
    ...
    const buyMeCoffeeUrl = process.env.NEXT_PUBLIC_BUY_ME_A_COFFEE_URL || 'https://buymeacoffee.com/lemondbd';
    const kofiUrl = process.env.NEXT_PUBLIC_KOFI_URL || 'https://ko-fi.com/lemondbd';
    const patreonUrl = process.env.NEXT_PUBLIC_PATREON_URL || 'https://patreon.com/lemondbd';
    ...
    const supportGateways = [
        {
            ...
            accentColor: 'border-amber-500/40 bg-amber-500/10 text-amber-400 hover:border-amber-400 hover:bg-amber-500/20',
            buttonBg: 'bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950',
            icon: Coffee,
        },
        {
            name: 'Ko-fi',
            ...
            accentColor: 'border-cyan-500/40 bg-cyan-500/10 text-cyan-400 hover:border-cyan-400 hover:bg-cyan-500/20',
            buttonBg: 'bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white',
            icon: Heart,
        },
        {
            ...
            accentColor: 'border-rose-500/40 bg-rose-500/10 text-rose-400 hover:border-rose-400 hover:bg-rose-500/20',
    ...
    return (
        ...
        @keyframes entityAuraAmber {
          0%, 100% {
            box-shadow: 0 0 25px 1px rgba(234, 179, 8, 0.2), inset 0 0 15px rgba(220, 38, 38, 0.1);
          }
          50% {
            box-shadow: 0 0 45px 5px rgba(234, 179, 8, 0.4), inset 0 0 25px rgba(220, 38, 38, 0.2);
          }
        }
      `}</style>
