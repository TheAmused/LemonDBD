          ...
          {activeMode === 'dashboard' ? (
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
              <div>
                <div className="flex items-center gap-2.5">
                  <div className="h-9 w-9 rounded-xl bg-violet-600/10 border border-violet-500/20 text-violet-600 dark:text-violet-400 flex items-center justify-center">
                    <Gamepad2 className="h-5 w-5 animate-pulse" />
                  </div>
                  <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white uppercase font-mono">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-slate-200 bg-slate-100 text-xs font-semibold text-slate-700 hover:bg-slate-200 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-300 dark:hover:bg-slate-800 transition-colors shadow-sm cursor-pointer"
              >
                {soundEnabled ? (
                  <>
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
              <button
                ...
                className="flex items-center gap-2 text-xs font-black tracking-wider text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white uppercase font-mono transition-colors group px-3 py-1.5 rounded-xl border border-slate-200 bg-white dark:border-slate-800/80 dark:bg-slate-900/40 cursor-pointer shadow-sm"
              >
                <ArrowLeft className="h-4 w-4 group-hover:-translate-x-1 transition-transform" />
                <span>{dict.guesser?.back || 'Back to modes'}</span>
              </button>

              <div className="flex items-center gap-4 bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 px-4 py-1.5 rounded-2xl shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-black text-sm text-violet-600 dark:text-violet-400 font-mono">
          ...
          {loadingData ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <div
                ...
                className="group relative flex flex-col justify-between p-5 rounded-2xl border border-slate-200 bg-white hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900/50 dark:hover:bg-slate-900/80 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-xl dark:shadow-none hover:border-violet-500/40 overflow-hidden"
              >
                ...
                <div className="space-y-3 relative z-10">
                  ...
                  <div>
                    <h2 className="text-lg font-black text-slate-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors uppercase tracking-tight font-mono">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-3xl border border-slate-200/90 bg-white/90 dark:border-slate-800 dark:bg-slate-900/60 backdrop-blur-xl p-5 sm:p-7 shadow-sm dark:shadow-2xl space-y-6">
                
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-black uppercase text-violet-600 dark:text-violet-400 tracking-widest">
                ...
                {currentQuestion && (
                  <div className="flex justify-center py-2">
                      ...
                      <div className="flex flex-col items-center gap-3 animate-in fade-in zoom-in-95 duration-200">
                        <div className="relative h-20 w-20 sm:h-24 sm:w-24 rounded-2xl overflow-hidden border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-950 flex items-center justify-center shadow-sm dark:shadow-lg">
                          {currentQuestion.type === 'avatar_to_name' ? (
                            ...
                            <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-slate-100 to-indigo-100/60 dark:from-slate-900 dark:to-indigo-950/60">
                              <HelpCircle className="h-8 w-8 text-slate-400 dark:text-slate-700/80 animate-pulse" />
                            </div>
                          )}
                        </div>
                        <span className="text-[11px] font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider bg-slate-100 dark:bg-slate-950/80 px-2.5 py-1 rounded-full border border-slate-200 dark:border-slate-800">
                    ...
                    {activeMode === 'memes' && (
                      <div className="flex flex-col items-center gap-3 animate-in fade-in zoom-in-95 duration-200">
                        <div className="relative h-20 w-20 sm:h-24 sm:w-24 rounded-2xl border border-pink-500/20 bg-pink-500/5 dark:bg-slate-950/80 flex items-center justify-center shadow-sm dark:shadow-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  {currentQuestion?.options.map((option, idx) => {
                    ...
                    if (gameState === 'playing') {
                      buttonClass +=
                        'border-slate-200 bg-slate-50 hover:bg-slate-100 hover:border-slate-300 text-slate-800 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-950/50 dark:hover:bg-slate-900/60 dark:hover:border-slate-700 dark:text-slate-300 dark:hover:text-white shadow-sm';
                    } else {
                      if (isCorrect) {
                        buttonClass +=
                          'border-emerald-500/40 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 shadow-md';
                      } else if (isSelected) {
                        buttonClass +=
                          'border-rose-500/40 bg-rose-500/10 text-rose-700 dark:text-rose-400 shadow-md';
                      } else {
                        buttonClass +=
                          'border-slate-200 bg-slate-100 text-slate-400 opacity-50 dark:border-slate-850 dark:bg-slate-950/20 dark:text-slate-600';
                      }
                    }
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] font-black text-slate-600 dark:text-slate-400 shadow-sm">
                              {idx + 1}
                            </span>
                ...
                {gameState === 'answered' && (
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-slate-100 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="flex items-center gap-3">
                      {selectedAnswerIndex === currentQuestion?.correctIndex ? (
                        <div className="h-8 w-8 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0">
                          <CheckCircle2 className="h-4 w-4" />
                        </div>
                      ) : (
                        <div className="h-8 w-8 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0">
