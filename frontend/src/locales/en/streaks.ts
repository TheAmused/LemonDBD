export default {
  ...
  perklessTrial: '0 Perks (Perkless Trial)',
  ...
  excGameCancelledText: 'someone left while the lobby was loading and the match never started. No reroll, queue again with the same one.',
  excHackersLabel: 'Hackers',
  excHackersText: 'obvious cheaters void the match. No reroll, replay the same one.',
  excCrashLabel: 'Crash or server failure',
  excCrashText: 'not a loss. No reroll, replay the same killer.',
  excSurvDcLabel: 'Survivor disconnects',
  excSurvDcText: 'keep playing. The bot match still counts.',
  excNoDodgingLabel: 'No dodging',
  excNoDodgingText: 'play whatever lobby you get, no matter the items or prestige levels.',
  excAddonsAllowedLabel: 'Add-ons and offerings',
  excAddonsAllowedText: 'are always allowed, at every tier.',
  excEarlyDcLabel: 'Early disconnect',
  excEarlyDcText: 'a survivor leaves before any generator finishes? The match does not count either way. No reroll, play the same character next time.',
  clarRatOffLabel: 'Rat off',
  clarRatOffText: 'survivors teaming up with the killer to get you out counts as a loss.',
  clarDeathIsDeathLabel: 'A death is a death',
  clarDeathIsDeathText: 'dying by any means during a live match counts, whether that is the killer, a hatchet, a sabotage play, or a survivor working against you.',
  clarKillerDcLabel: 'Killer disconnects',
  clarKillerDcText: 'if they rage quit after a generator is done, it counts as an escape. If they left from a bug or server issue, it does not count. No reroll, replay the same character.',
  ...
  tierWarmUpDesc: 'Full 4 perk loadout.',
  tierThinning: 'The Thinning',
  tierThinningDesc: 'Down to 3 perks.',
  tierStruggle: 'The Struggle',
  tierStruggleDesc: 'Down to 2 perks.',
  tierHardcore: 'The Hardcore',
  tierHardcoreDesc: 'Just 1 perk.',
  tierLegend: 'The Legend',
  tierLegendDesc: 'No perks. The full perkless trial.',
  tierBloodbath: 'The Bloodbath',
  tierBloodbathDesc: 'All 3 of your own perks.',
  tierObsession: 'The Obsession',
  tierObsessionDesc: 'Pick any 2 of your own.',
  tierExecutioner: 'The Executioner',
  tierExecutionerDesc: 'Pick any 1 of your own.',
  tierEntity: 'The Entity',
  tierEntityDesc: 'No perks. The full perkless trial.',
} as const;
