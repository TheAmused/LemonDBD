...
export default {
  ...
  devotion: "Hingabe",
  gradeRank: "Rangstufe",
  survivorMain: "Überlebenden-Main",
  killerMain: "Killer-Main",
  prestige: "Prestige",
  selectPerk: "Perk auswählen",
  selectCharacter: "Charakter auswählen",
  emptySlot: "Leerer Perk-Slot",
  searchCharacters: "Charaktere suchen...",
  searchPerks: "Perks suchen...",
  savedToDatabase: "In Datenbank gespeichert",
  savingToDatabase: "Im Nebel speichern...",
  vaultMastery: "Tresor-Meisterschaft",
  streakRecords: "Prüfungstrophäen & Rekorde",
  changeMain: "Main wechseln",
  clearPerk: "Perk leeren",
  allPerksUnlocked: "Alle Perks freigeschaltet",
  ok: "OK",
  editDevotionTitle: "Klicken, um Hingabe-Stufe zu bearbeiten",
  lvlPrefix: "Stufe",
  offlineCached: "Offline (Gespeichert)",
  decreasePrestige: "Prestige verringern",
  increasePrestige: "Prestige erhöhen",
  prestigeProgress: "Prestige-Stufe {level} von 100",
  signatureLoadout: "4-Perk-Signatur-Build",
  equippedCount: "{count}/4 ausgerüstet",
  slotPrefix: "Slot",
  chooseCharacterDesc: "Wähle deinen primären Charakter für das Lagerfeuer.",
  loadingCharacters: "Nebel wird durchsucht...",
  noCharactersFound: "Keine passenden Charaktere gefunden.",
  choosePerkDesc: "Wähle einen Perk für dein 4-Perk-Rauten-Loadout.",
  loadingPerks: "Perk-Wissen wird abgerufen...",
  noPerksFound: "Keine passenden Perks gefunden.",
  gauntletTitle: "Gauntlet",
  gauntletDesc: "Aufeinanderfolgende Prüfungssiege ohne doppelte Perks.",
  chaosTitle: "Chaos Shuffle",
  chaosDesc: "Zufälliger Build gegen die unberechenbare Entität.",
