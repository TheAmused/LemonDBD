...
export default {
  ...
  jackpotLinesKiller: [
    "The Entity is pleased. 4K incoming, basement hooks ready.",
    "Bring on the flashlight clickers. They're not escaping this one.",
    "Someone is getting hooked in the basement before the first gen pops.",
    "The Entity hungers, and you're about to serve up a four-course meal.",
    "Post-game chat salt incoming. Grab your popcorn.",
    "Time to turn that SWF squad into a lobby of panicked screams.",
    "No Hatch for you. The Entity demands all four sacrifices.",
    "Hex totems cleansed in 10 seconds? Not with this build.",
    "Hooked, camped, sacrificed. Just another Tuesday in the Fog.",
    "Survivors brought flashlights and map offerings? Big mistake."
  ],
