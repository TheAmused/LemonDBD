...
CREATE TABLE IF NOT EXISTS chaos_runs (
    ...
    best_streak INTEGER NOT NULL DEFAULT 0,
    last_checkpoint_streak INTEGER NOT NULL DEFAULT 0,
    completed_killers TEXT NOT NULL DEFAULT '[]',
    checkpoint_killers TEXT NOT NULL DEFAULT '[]',
    used_perks TEXT NOT NULL DEFAULT '[]',
    checkpoint_used_perks TEXT NOT NULL DEFAULT '[]',
    current_perks TEXT NOT NULL DEFAULT '[]',
    current_addon_rarities TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS history_runs (
    ...
    completed_killers TEXT NOT NULL DEFAULT '[]',
    unlocked_perk_names TEXT NOT NULL DEFAULT '[]',
    checkpoint_row_index INTEGER NOT NULL DEFAULT 0,
    checkpoint_total_killers_beaten INTEGER NOT NULL DEFAULT 0,
    checkpoint_completed_killers TEXT NOT NULL DEFAULT '[]',
    checkpoint_unlocked_perk_names TEXT NOT NULL DEFAULT '[]',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
