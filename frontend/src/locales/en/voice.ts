...
export default {
  ...
  switchedToLocalEngine: "Network error. Switched to the local speech engine.",
  speechRecognitionErrorPrefix: "Speech recognition error:",
  noSpeechDetected: "No speech detected.",
  trySayingPrompt: "Try saying a map name, like \"The Game\" or \"Ormond Lake Mine\".",
  noDbdMatch: "no match found",
  checkPermissionsHint: "Check your browser's microphone permissions and try again.",
  transcribingPrefix: "Transcribing:",
  transcribingVoice: "Transcribing your voice...",
  localWasmInference: "Running local WASM speech inference",
  matchedPrefix: "Opening map:",
  switchedPrefix: "Switched source to:",
  actionPrefix: "Action:",
  listeningVoice: "Listening...",
  speakMapPrompt: "Say a map name...",
  localModelListeningDesc: "Processing locally with the on-device AI model",
  webSpeechListeningDesc: "Streaming to your browser's speech recognition service",
  muteSound: "Mute sound",
  enableSound: "Enable sound",
  viewEngineInfo: "View voice engine info",
  webSpeechTooltip: "Speech is processed by your browser's native cloud engine (Google / Apple).",
