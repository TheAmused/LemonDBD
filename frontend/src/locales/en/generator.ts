export default {
  ...
  instantRollPrompt: "Rolls all four perks at once, instantly -- no wheel, no waiting. Page and slot are decided the moment you click.",
  ...
  slotJammedDesc: "This reel is broken for the whole draw -- it can never be picked. Pull a brand-new draw to clear it.",
  ...
  lowPoolEmptyDesc: "No-Repeat Mode has drawn every playable perk -- there's nothing left to pull. Reset your drawn-perk memory to open the pool back up.",
