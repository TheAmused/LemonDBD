...
export const UserMetricsGridSkeleton: React.FC<{ className?: string; dict?: Dictionary | null }> = ({ className = '', dict }) => (
  <div
    ...
    className={`w-full min-h-[120px] flex items-center justify-center p-4 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/60 ${className}`}
  >
...
export const UserMetricsGrid: React.FC<UserMetricsGridProps> = ({ ownership, dict }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-5 w-full">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/60 p-4 sm:p-5 backdrop-blur-xl shadow-sm dark:shadow-lg space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base font-black text-slate-900 dark:text-slate-100 font-mono">
                {survOwned} / {survTotal}
              </p>
            </div>
          </div>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/60 p-4 sm:p-5 backdrop-blur-xl shadow-sm dark:shadow-lg space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-red-500/10 border border-red-500/20 text-rose-600 dark:text-rose-400">
