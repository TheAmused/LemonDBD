    ...
    >
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-sans">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/80 text-sm leading-relaxed whitespace-pre-line text-slate-800 dark:text-slate-200 font-medium">
            {rawLoreText}
          </div>
        </div>
