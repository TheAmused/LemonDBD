...
export default {
  ...
  categoryFirecracker: "Firecracker",
  artifactMechanics: "Artifact Mechanics",
  specialTrialRules: "Special Trial Rules",
  inTrialArtifactsHeading: "In-Trial Killer Counters & Artifacts",
  trialArtifactsDesc1: "These unique artifacts (such as Hand & Eye of Vecna, Lament Configuration, Remote Flame Turrets, EMPs, First Aid Sprays, and Vaccines) cannot be equipped in the pre-game lobby.",
  trialArtifactsDesc2: "They are spawned inside the Trial grounds to interact directly with specific Killers' powers and counteract their special abilities.",
  ...
  combatAttributes: 'Combat Attributes & Terror Radius',
