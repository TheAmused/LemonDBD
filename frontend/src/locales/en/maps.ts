export default {
  ...
  quadrantSystemSubtitle: 'Steam Workshop 3D Isometric Map Reference',
  quadrantSystemTitle: 'Steam Workshop 3D Isometric Map Reference',
  samoelIsometricScheme: 'SamoelColt Isometric',
  sixOClock: '6 o\'clock',
